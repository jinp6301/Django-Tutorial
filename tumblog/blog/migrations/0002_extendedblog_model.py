...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_blog', 'created',
        ...
        db.add_column('blog_blog', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 9, 14, 0, 0), blank=True),
                      keep_default=False)
