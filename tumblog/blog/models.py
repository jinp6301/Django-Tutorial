...
class Blog(TimeStampedActivate):
	...
	name = models.CharField(max_length = 255,
		help_text = 'name of your blog. Anything up to 255 characters')
...
class Post(TimeStampedActivate):
	...
	"""
	title = models.CharField(max_length = 255, help_text = "Title of the post. Can be anything up to 255 characters")
	slug = models.SlugField()
	excerpt = models.TextField(blank = True, help_text = "A small teaser of your content")
