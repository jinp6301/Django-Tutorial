...
class PostAdmin(admin.ModelAdmin):
	...
	search_fields = ['title', 'excerpt', 'body', 'blog__user__username']
	fieldsets = (
		(None, {
			'fields': ('title', 'blog'),
			}),
		('Publication', {'fields': ('active', 'publish_at'),
			'description': "Control <strong>whether</strong> or not <strong>when</strong> a post is visible to the world"
			}),
		('Content', {
